...
## Entitites
## Functions/methods
ZSH_HIGHLIGHT_STYLES[alias]='fg=#a6e3a1,underline'
...
ZSH_HIGHLIGHT_STYLES[path]='fg=#b4befe,bold'
ZSH_HIGHLIGHT_STYLES[path_pathseparator]='fg=#b4befe,bold'
ZSH_HIGHLIGHT_STYLES[path_prefix]='fg=#b4befe'
ZSH_HIGHLIGHT_STYLES[path_prefix_pathseparator]='fg=#b4befe'
ZSH_HIGHLIGHT_STYLES[globbing]='fg=#b4befe,bold'
